...
SHORTLINK_API = environ.get('SHORTLINK_API', 'ab99d34d4afc839ad880d568ca72e7b0e0c889f6')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002022141785')).split()]
...
URL = "https://kishorafilter-bot.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://kishorafilter-bot.onrender.com/".format(FQDN, PORT)
